...
def create_network_and_routes():
    ...
    _sumo_dispatch_value = "traci" if (_dispatch_algo == "hungarian" or taxi_strategy == "rl_prepositioned") else _dispatch_algo
    ...
    meta = {
        ...
        "taxi_dispatch_algorithm": CFG.get("taxi_dispatch_algorithm", "greedy"),
    }
