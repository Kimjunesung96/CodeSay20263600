...
def clone_for_algo_b(algo_b: str):
    ...
    for elem in root.iter("device.taxi.dispatch-algorithm"):
        elem.set("value", _sumo_dispatch_value(algo_b, meta.get("taxi_strategy")))
...
def compare(algo_a: str, algo_b: str):
    ...
    a_metric = result_a.get("true_avg_wait_sec_with_penalty")
    b_metric = result_b.get("true_avg_wait_sec_with_penalty")
