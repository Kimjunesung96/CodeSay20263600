...
"Module 4 — 배차/인센티브":[("incentive_weight","인센티브 리워드 가중치",0,5,2,0),("target_hotspot_ratio","목표 핫스팟 택시 비율(0~1)",0,1,2,0),("mock_available_taxis_min","테스트 가용택시 최소",0,500,0,1),("mock_available_taxis_max","테스트 가용택시 최대",0,500,0,1),("mock_taxi_count","배차 테스트 택시 수",1,500,0,1),("mock_passenger_count","배차 테스트 승객 수",1,500,0,1)],
