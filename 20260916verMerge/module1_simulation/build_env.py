...
def create_network_and_routes():
    ...
    if _dispatch_algo not in ("greedy", "routeExtension", "hungarian", "rl_reposition"):
        raise ValueError("배차 알고리즘은 greedy/routeExtension/hungarian/rl_reposition 중에서 선택하세요.")
    ...
    meta = {
        ...
        "taxi_dispatch_algorithm": CFG.get("taxi_dispatch_algorithm", "greedy"),  # <-- 여기에 추가!
    }
